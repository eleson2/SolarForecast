...
| Modbus TCP driver  | Done        | `growatt-modbus` — local Modbus TCP for MOD TL3-XH, SOC buffer control + peak shaving + Grid First sell mode (reg 3038, gated by `inverter.grid_first_sell`) |
